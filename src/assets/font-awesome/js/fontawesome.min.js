...
!(function () {
    ...
    return "string" == typeof t
      ...
      : "<"
          ...
          .concat(
            ...
            Object.keys(r || {})
              .reduce(
                (t, n) => t + "".concat(n, '="').concat(lt(r[n]), '" '),
                ""
              )
              .trim()),
            ">"
          )
          .concat(a.map(kt).join(""), "</")
          .concat(n, ">");
    var r;
  }
  function wt(t, n, e) {
  ...
  function Ct(t, n, e) {
    var { skipHooks: a = !1 } = 2 < arguments.length && void 0 !== e ? e : {},
      e = Pt(n);
  ...
  function Ut(t, n) {
    var { family: e = l } = 1 < arguments.length && void 0 !== n ? n : {},
      n = Y[e][t],
      n = W[e][t] || W[e][n],
  ...
  function qt(t, n) {
    ...
    const e = t.reduce((t, n) => {
      ...
      return (
        St[n]
          ? ((n = Mt[s].includes(n) ? X[s][n] : n), (o = n), (t.prefix = n))
          : -1 < Dt[s].indexOf(n)
          ? ((o = n),
            (t.prefix = Ut(n, {
              family: s,
          ...
          : a
          ? (t.iconName = a)
          : n === nt.replacementClass ||
            c.some((t) => n === i[t]) ||
            t.rest.push(n),
        !r &&
          t.prefix &&
          t.iconName &&
          ((e = "fa" === o ? _t(t.iconName) : {}),
          (a = Wt(t.prefix, t.iconName)),
          e.prefix && (o = null),
    ...
    return (
      (t.includes("fa-brands") || t.includes("fab")) && (e.prefix = "fab"),
      (t.includes("fa-duotone") || t.includes("fad")) && (e.prefix = "fad"),
      e.prefix ||
        s !== d ||
        (!St.fass && !nt.autoFetchSvg) ||
        ((e.prefix = "fass"),
        (e.iconName = Wt(e.prefix, e.iconName) || e.iconName)),
      e.prefix ||
        s !== p ||
        (!St.fasds && !nt.autoFetchSvg) ||
        ((e.prefix = "fasds"),
        (e.iconName = Wt(e.prefix, e.iconName) || e.iconName)),
      ("fa" !== e.prefix && "fa" !== o) || (e.prefix = zt || "fas"),
      e
    );
  }
  let Vt = [],
  ...
  function Qt(t, n) {
    for (
      var e = arguments.length, a = new Array(2 < e ? e - 2 : 0), r = 2;
      r < e;
      r++
    )
      a[r - 2] = arguments[r];
  ...
  function Zt(t) {
    for (
      var n = arguments.length, e = new Array(1 < n ? n - 1 : 0), a = 1;
      a < n;
      a++
    )
      e[a - 1] = arguments[a];
  ...
  function tn(t) {
    ...
    if (n)
      return (
        (n = Wt(t, n) || n), wt(nn.definitions, t, n) || wt(gt.styles, t, n)
      );
  }
  const nn = new (class {
    constructor() {
    ...
    _pullDefinitions(i, t) {
      ...
      return (
        Object.keys(o).map((t) => {
          const { prefix: n, iconName: e, icon: a } = o[t],
            r = a[2];
          i[n] || (i[n] = {}),
            0 < r.length &&
              r.forEach((t) => {
  ...
  const en = {
      ...
      parse: {
        icon: (t) => {
          ...
          if (
            "string" == typeof t &&
            (-1 < t.indexOf("".concat(nt.cssPrefix, "-")) || t.match(q))
          ) {
            n = qt(t.split(" "), {
              skipLookups: !0,
            });
    ...
    an = function () {
      ...
      (0 < Object.keys(gt.styles).length || nt.autoFetchSvg) &&
        f &&
        nt.autoReplaceSvg &&
        en.dom.i2svg({
          node: t,
  ...
  function on(t) {
    ...
    var { width: m, height: d } = e.found ? e : n,
      p = "fak" === a,
      t = [nt.replacementClass, r ? "".concat(nt.cssPrefix, "-").concat(r) : ""]
      ...
      (o
        ? function (t) {
            var {
              ...
              t =
                !0 === t
                  ? "".concat(n, "-").concat(nt.cssPrefix, "-").concat(e)
                  : t;
            return [
              {
                tag: "svg",
    ...
    ut(r) &&
      ((l.transform = (function (t) {
        ...
        return (
          t && u
            ? (r += "translate("
                .concat(n.x / at - e / 2, "em, ")
                .concat(n.y / at - a / 2, "em) "))
            : (r += t
                ? "translate(calc(-50% + "
                    .concat(n.x / at, "em), calc(-50% + ")
                    .concat(n.y / at, "em)) ")
                : "translate("
                    .concat(n.x / at, "em, ")
                    .concat(n.y / at, "em) ")),
          (r += "scale("
            .concat((n.size / at) * (n.flipX ? -1 : 1), ", ")
            .concat((n.size / at) * (n.flipY ? -1 : 1), ") ")),
  ...
  function un(r, i) {
    let o = i;
    return (
      "fa" === i && null !== nt.styleDefault && (i = zt),
      new Promise((t, n) => {
        var e, a;
        if (
          ("fa" === o &&
            ((a = _t(r) || {}), (r = a.iconName || r), (i = a.prefix || i)),
          r && i && cn[i] && cn[i][r])
        )
          return t(ln(cn[i][r]));
        (e = r),
  ...
  y = () => {};
  const mn =
      nt.measurePerformance && o && o.mark && o.measure
        ? o
        : {
            mark: y,
            measure: y,
    ...
    dn = 'FA "6.6.0"';
  const pn = (t) => {
    mn.mark("".concat(dn, " ").concat(t, " ends")),
      mn.measure(
        "".concat(dn, " ").concat(t),
        "".concat(dn, " ").concat(t, " begins"),
        "".concat(dn, " ").concat(t, " ends")
      );
  };
  var hn = {
    begin: (t) => (
      mn.mark("".concat(dn, " ").concat(t, " begins")), () => pn(t)
    ),
    end: pn,
  };
  const gn = () => {};
  ...
  const yn = {
    replace: function (t) {
      ...
      n.parentNode &&
        ...
        null === n.getAttribute(C) && nt.keepOriginalSource
          ? ((t = w.createComment(
              ((t = n),
    ...
    nest: function (t) {
      ...
      if ((delete e[0].attributes.id, e[0].attributes.class)) {
        const r = e[0].attributes.class
          .split(" ")
          .reduce(
            (t, n) => (
              (n === nt.replacementClass || n.match(a)
                ? t.toSvg
                : t.toNode
              ).push(n),
              t
  ...
  function kn(e, t) {
    ...
    if (0 === e.length) a();
      ...
      let t = xn;
      nt.mutateApproach === F && (t = k.requestAnimationFrame || xn),
        t(() => {
          var t =
            (!0 !== nt.autoReplaceSvg && yn[nt.autoReplaceSvg]) || yn.replace;
      ...
      if (!wn) {
        ...
        st(t).forEach((t) => {
          ...
          "childList" === t.type &&
            ...
            !bn(t.addedNodes[0]) &&
            (nt.searchPseudoElements && s(t.target), i(t.target)),
            "attributes" === t.type &&
              t.target.parentNode &&
              nt.searchPseudoElements &&
            ...
            "attributes" === t.type &&
              ...
              ((e = t.target),
              (a = e.getAttribute ? e.getAttribute(M) : null),
              (e = e.getAttribute ? e.getAttribute(z) : null),
              a && e)
                ? (({ prefix: e, iconName: n } = qt(ct(t.target))),
                  t.target.setAttribute(M, e || r),
                  n && t.target.setAttribute(z, n))
                : (n = t.target) &&
                  n.classList &&
                  n.classList.contains &&
                  n.classList.contains(nt.replacementClass) &&
                  o(t.target));
        });
      }
    })),
      ...
      (r.iconName && r.prefix) ||
        (r.prefix &&
          ...
          (r.iconName =
            ((e = r.prefix),
            (a = t.innerText),
            (Ft[e] || {})[a] || Ht(r.prefix, Ot(t.innerText)))),
        !r.iconName &&
          nt.autoFetchSvg &&
          t.firstChild &&
  ...
  function Sn(t, n) {
    var e =
      ...
      { iconName: a, prefix: r, rest: i } = Cn(t),
      o = (function (t) {
        const n = st(t.attributes).reduce(
          (t, n) => (
            "class" !== t.name && "style" !== t.name && (t[n.name] = n.value), t
          ),
          {}
        );
        ...
        return (
          nt.autoA11y &&
            (e
              ? (n["aria-labelledby"] = ""
                  .concat(nt.replacementClass, "-title-")
                  .concat(t || ot()))
              : ((n["aria-hidden"] = "true"), (n.focusable = "false"))),
          n
        );
      })(t),
      n = Qt("parseNodeAttributes", {}, t),
      e = e.styleParser
        ? (function (t) {
  ...
  function Mn(t) {
    const n =
      "nest" === nt.autoReplaceSvg
        ? Sn(t, {
            styleParser: !1,
          })
        : Sn(t);
    return ~n.extra.classes.indexOf(V)
      ? $t("generateLayersText", t, n)
      : $t("generateSvgReplacementMutation", t, n);
  }
  let zn = new Set();
  function jn(t) {
    let a =
    ...
    const n = w.documentElement.classList,
      r = (t) => n.add("".concat(j, "-").concat(t)),
      i = (t) => n.remove("".concat(j, "-").concat(t)),
      e = nt.autoFetchSvg
        ? zn
        : I.map((t) => "fa-".concat(t)).concat(Object.keys(En));
    e.includes("fa") || e.push("fa");
    var o = [".".concat(V, ":not([").concat(C, "])")]
      .concat(e.map((t) => ".".concat(t, ":not([").concat(C, "])")))
      .join(", ");
  ...
  I.map((t) => {
    ...
    Object.keys(Y[l]).map(zn.add.bind(zn)),
    Object.keys(Y[d]).map(zn.add.bind(zn)),
    Object.keys(Y[p]).map(zn.add.bind(zn)),
    (zn = [...zn]);
  function Ln(t) {
        ...
        t.generateLayersText = function (t, n) {
          ...
          return (
            u &&
              ...
              (i = n.width / s),
              (o = n.height / s)),
            nt.autoA11y && !e && (r.attributes["aria-hidden"] = "true"),
            Promise.resolve([
              t,
              sn({
                content: t.innerHTML,
  ...
  const Rn = new RegExp('"', "ug"),
    ...
    Tn = Object.keys(Dn).reduce(
      (t, n) => ((t[n.toLowerCase()] = Dn[n]), t),
      {}
    ),
    Yn = Object.keys(Tn).reduce((t, n) => {
      var e = Tn[n];
  ...
  function Hn(v, y) {
    ...
    return new Promise((i, n) => {
      ...
      const t = st(v.children),
        e = t.filter((t) => t.getAttribute(S) === y)[0],
        ...
        if (
          (h &&
            ...
            (h = d ||
              ...
              h.prefix &&
              ((t = h.iconName), (a = h.prefix))),
          !t || p || (e && e.getAttribute(M) === a && e.getAttribute(z) === r))
        )
          i();
        else {
  ...
  !(function (t, n) {
      ...
      },
      {
        ...
        provides(t) {
          t.generateAbstractTransformGrouping = function (t) {
            var { main: n, transform: e, containerWidth: a, iconWidth: r } = t,
              i = {
      ...
      },
      {
          ...
          return {
            parseNodeAttributes(t, n) {
              const e = n.getAttribute("data-fa-mask"),
                a = e ? qt(e.split(" ").map((t) => t.trim())) : Bt();
              return (
        ...
        provides(t) {
          t.generateAbstractMask = function (t) {
            ...
            const { width: s, icon: c } = a;
            var { width: l, icon: f } = r,
              u = (function (t) {
                var { transform: n, containerWidth: e, iconWidth: a } = t,
                  r = {
    ...
    (function (t) {
      ...
      s &&
        (k.FontAwesome || (k.FontAwesome = en),
        xt(() => {
          an(), Zt("bootstrap");
        })),
        (gt.hooks = {
